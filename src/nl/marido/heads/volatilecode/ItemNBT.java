package nl.marido.heads.volatilecode;
...
import nl.marido.heads.volatilecode.reflection.craftbukkit.CraftItemStack;
import nl.marido.heads.volatilecode.reflection.nms.ItemStack;
import nl.marido.heads.volatilecode.reflection.nms.nbt.NBTTagCompound;
import nl.marido.heads.volatilecode.reflection.nms.nbt.NBTTagList;
import nl.marido.heads.volatilecode.reflection.nms.nbt.NBTTagString;
...
public class ItemNBT {
	...
	private static ItemStack createNMSSkull() {
		if (Version.isBelow(Version.v1_13))
			return new ItemStack(nl.marido.heads.volatilecode.reflection.nms.Items.getItem("SKULL"), 1, 3);

		return new ItemStack(nl.marido.heads.volatilecode.reflection.nms.Items.getItem("PLAYER_HEAD"), 1);
	}
